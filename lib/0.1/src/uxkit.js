...
/**
 *
 * @param rippled {HTMLElement} Style class must include 'rippled'
 */
function addRippleEffect(rippled)
{
    ...
    if (!isMobile())
    {
        rippled.addEventListener("mousedown", (e) => rippleStart(e));
        rippled.addEventListener("mouseup", () => rippleEnd());
    }
    else
    {
        rippled.addEventListener("touchstart", (e) => rippleStart(e), false);
        rippled.addEventListener("touchend", () => rippleEnd(), false);
    }
}
/**
 *
